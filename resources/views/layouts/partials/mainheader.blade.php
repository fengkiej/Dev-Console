...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini">D<b>Cl</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">Dev<b>Console</b></span>
    </a>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            <img src="/img/user2-160x160.jpg" class="img-circle" alt="User Image"/> <!-- TODO: change this src -->
                                        </div>
